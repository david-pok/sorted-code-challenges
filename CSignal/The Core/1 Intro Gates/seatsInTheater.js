// Your friend advised you to see a new performance
// in the most popular theater in the city.
...
// you're afraid that you'll end up blocking
// the view (even if only for a couple of seconds)
// of all the people who sit behind you and in your
// column or the columns to your left. To gain some courage,
// you decide to calculate the number of such people
// and see if you can possibly make it to the
// exit without disturbing too many people.

// Given the total number of rows and
// columns in the theater (nRows and nCols, respectively),
